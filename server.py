...
# Path to the dataset directory used for training (to retrieve class names)
...
def index():
    return jsonify({'status': 'running', 'message': 'Meow Lang Server is active. Send POST requests to /convert'}), 200

@app.errorhandler(404)
def not_found(e):
    return jsonify({'error': 'Not Found', 'message': 'The requested URL was not found on the server. Ensure you are using /convert'}), 404
